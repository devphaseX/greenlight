...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "193f60f9bc6325", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "8c17f57b2d761a", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.ayomide.net>", "SMTP sender")
